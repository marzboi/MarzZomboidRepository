...
Events.OnInitWorld.Add(function()
    ...
    Adjust("Base.357Bullets", "WorldStaticModel", "New_357_Round")
    Adjust("Base.10mmBullets", "WorldStaticModel", "New_10mm_Round")
    Adjust("Base.SlugBullets", "WorldStaticModel", "New_ShotgunSlug_Round")
    Adjust("Base.40Bullets", "WorldStaticModel", "New_40_Round")
    -- Ammo icons
    ...
    Adjust("Base.357Bullets", "icon", "357_Round")
    Adjust("Base.10mmBullets", "icon", "10mm_Round")
    Adjust("Base.SlugBullets", "icon", "ShotgunSlug_Round")
    Adjust("Base.40Bullets", "icon", "38_Round")
end)
