...
--     -- GatherGunpowderFromLightRounds - build combined mapping
...
--     -- GatherGunpowderFromMediumRounds - build combined mapping
...
--     -- GatherGunpowderFromHeavyRounds - build combined mapping
...
--     -- MakeLightRound - build combined mapping
...
--     -- MakeMediumRound - build combined mapping
...
--     -- MakeHeavyRound - build combined mapping
