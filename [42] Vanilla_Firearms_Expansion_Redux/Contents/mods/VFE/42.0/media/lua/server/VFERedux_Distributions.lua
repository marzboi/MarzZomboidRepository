...
local function VFEHouseDistro()
    ...
    VFEGenerateLongFirearmsDistro(ProceduralDistributions.list.WardrobeChild) --heh

    -- Wardrobe Man Classy Long Guns
    VFEGenerateLongFirearmsDistro(ProceduralDistributions.list.WardrobeClassy) -- classic man here
    ...
    VFEGenerateLongFirearmsDistro(ProceduralDistributions.list.WardrobeGeneric) -- previously woman

    -- Wardrobe Woman Classy Long Guns
    VFEGenerateLongFirearmsDistro(ProceduralDistributions.list.WeddingStoreDresses) -- classic woman
end
...
local function VFEVehicleDistro()
    ...
    table.insert(VehicleDistributions.SurvivalistGloveBox.items, "Glock");
    table.insert(VehicleDistributions.SurvivalistGloveBox.items, 2.5);
    table.insert(VehicleDistributions.SurvivalistGloveBox.items, "CZ75");
    table.insert(VehicleDistributions.SurvivalistGloveBox.items, 1.5);
    table.insert(VehicleDistributions.SurvivalistGloveBox.items, "Tec9");
    table.insert(VehicleDistributions.SurvivalistGloveBox.items, 1.5);
