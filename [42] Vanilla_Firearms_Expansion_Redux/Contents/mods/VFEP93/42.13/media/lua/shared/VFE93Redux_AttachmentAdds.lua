...
VFETweaks:addToMountOn("Base.RedDot", "Base.M4A1");
...
VFETweaks:addToMountOn("Base.RedDot", "Base.SPRSD");
VFETweaks:addToMountOn("Base.x2Scope", "Base.SPRSD");
...
VFETweaks:addToMountOn("Base.Coupled556", "Base.SPRSD");
...
VFETweaks:addToMountOn("Base.Coupled556", "Base.SPR");

VFETweaks:addToMountOn("Base.Coupled556", "Base.n418");

VFETweaks:addToMountOn("Base.Coupled556", "Base.n418sd");


VFETweaks:addToMountOn("Base.RedDot", "Base.Vector45");
VFETweaks:addToMountOn("Base.Laser", "Base.Vector45");


VFETweaks:addToMountOn("Base.RedDot", "Base.Vector9");
VFETweaks:addToMountOn("Base.Laser", "Base.Vector9");


VFETweaks:addToMountOn("Base.RedDot", "Base.P90");
VFETweaks:addToMountOn("Base.Laser", "Base.P90");


VFETweaks:addToMountOn("Base.RedDot", "Base.MP7");
